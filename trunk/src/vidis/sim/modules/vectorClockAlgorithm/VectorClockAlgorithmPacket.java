...
public class VectorClockAlgorithmPacket extends SimulatorComponentPacket {

	public VectorClockAlgorithmPacket(ComponentFactoryInt factory, SimulatorComponentNode from, SimulatorComponentNode to, long time) {
