package vidis.sim.modules.demo;
 ...
 *
 */
public class DemoFactory extends SimulatorComponentFactory {
	...
	public SimulatorComponentLink getNewLink(long delay) {
		SimulatorComponentLink link = new DemoLink(this, delay);
	...
	public SimulatorComponentNode getNewNode() {
		SimulatorComponentNode node = new DemoNode(this);
	...
	public SimulatorComponentPacket getNewPacket(SimulatorComponentNode from, SimulatorComponentNode to, long time) {
		SimulatorComponentPacket packet = new DemoPacket(this, from, to, time);
