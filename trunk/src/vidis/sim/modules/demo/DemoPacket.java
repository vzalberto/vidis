...
public class DemoPacket extends SimulatorComponentPacket {

	public DemoPacket(ComponentFactoryInt factory, SimulatorComponentNode from, SimulatorComponentNode to, long time) {
