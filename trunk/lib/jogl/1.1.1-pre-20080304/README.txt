...
Java (TM) Binding for the OpenGL (r) API, version 1.1.1-pre-20080304
-------------------------------------------------------

This software is licensed by Sun Microsystems, as specified
in the LICENSE-JOGL-1.1.1-pre-20080304.txt file.  You must use this software 
in accordance with the terms under which the code is licensed.



Instructions for unzipping Java Binding for the OpenGL API, version 1.1.1-pre-20080304
--------------------------------------------------------------------
...
following files in the top directory:
  ...
  COPYRIGHT.txt
  LICENSE-JOGL-1.1.1-pre-20080304.txt
  Userguide.html
